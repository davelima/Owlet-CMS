...
$upload_dir = '/admin/uploads/usr/'; // path from base_url to upload base dir
$current_path = '../../../../../uploads/usr/'; // relative path from filemanager folder to upload files folder
