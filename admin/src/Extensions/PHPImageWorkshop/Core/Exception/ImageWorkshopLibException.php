...
namespace Extensions\PHPImageWorkshop\Core\Exception;

use Extensions\PHPImageWorkshop\Exception\ImageWorkshopBaseException as ImageWorkshopBaseException;
